...
public class AlloyFurnaceScreenHandler extends ScreenHandler {
    ...
    public AlloyFurnaceScreenHandler(int syncId, PlayerInventory playerInventory,
        ...
        super(CustomScreenHandlers.ALLOY_FURNACE_SCREEN_HANDLER, syncId);
        ...
        //
        this.addSlot(new CustomFuelSlot(inventory, 0, 62, 58));
        this.addSlot(new Slot(inventory, 1, 48, 22));
        this.addSlot(new Slot(inventory, 2, 76, 22));
        this.addSlot(new CustomResultSlot(inventory, 3, 124, 22));
