...
public class RunicArtifactScreen extends HandledScreen<RunicArtifactScreenHandler> {
    public static final Identifier TEXTURE = new Identifier
            (Reborn12K.MOD_ID,"textures/gui/runic_artifact_gui.png");

    public RunicArtifactScreen(RunicArtifactScreenHandler handler, PlayerInventory inventory, Text title) {
