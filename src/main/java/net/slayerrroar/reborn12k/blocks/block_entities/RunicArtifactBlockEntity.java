...
public class RunicArtifactBlockEntity extends BlockEntity implements NamedScreenHandlerFactory, ImplementedInventory {
    ...
    public Text getDisplayName() {
        return Text.translatable("block.reborn12k.runic_artifact");
    }
    ...
    public static void tick(World world, BlockPos blockPos, BlockState state, RunicArtifactBlockEntity entity) {
        if(world.isClient()) {
            return;
        }
    ...
    private static void craftItem(RunicArtifactBlockEntity entity) {
        ...
        Optional<RunicArtifactRecipe> recipe = entity.getWorld().getRecipeManager()
                .getFirstMatch(RunicArtifactRecipe.Type.INSTANCE, inventory, entity.getWorld());
    ...
    private static boolean hasRecipe(RunicArtifactBlockEntity entity) {
        ...
        Optional<RunicArtifactRecipe> match = entity.getWorld().getRecipeManager()
                .getFirstMatch(RunicArtifactRecipe.Type.INSTANCE, inventory, entity.getWorld());
