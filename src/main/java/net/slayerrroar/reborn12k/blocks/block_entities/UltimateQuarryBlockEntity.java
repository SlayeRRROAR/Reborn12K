package net.slayerrroar.reborn12k.blocks.block_entities;
...
import net.slayerrroar.reborn12k.recipe.QuarryRecipe;
...
public class UltimateQuarryBlockEntity extends BlockEntity implements NamedScreenHandlerFactory, ImplementedInventory {
    ...
    public UltimateQuarryBlockEntity(BlockPos pos, BlockState state) {
        super(CustomBlockEntities.ULTIMATE_QUARRY, pos, state);
        this.propertyDelegate = new PropertyDelegate() {
            @Override
            public int get(int index) {
                return switch (index) {
                    case 0 -> UltimateQuarryBlockEntity.this.progress;
                    case 1 -> UltimateQuarryBlockEntity.this.maxProgress;
                    default -> 0;
                };
            }
            ...
            public void set(int index, int value) {
                switch (index) {
                    case 0 -> UltimateQuarryBlockEntity.this.progress = value;
                    case 1 -> UltimateQuarryBlockEntity.this.maxProgress = value;
                }
            }
    ...
    public Text getDisplayName() {
        return Text.translatable("block.reborn12k.ultimate_laser_quarry");
    }
    ...
    protected void writeNbt(NbtCompound nbt) {
        ...
        super.writeNbt(nbt);
        nbt.putInt("ultimate_quarry.progress", progress);
    }
    ...
    public void readNbt(NbtCompound nbt) {
        ...
        super.readNbt(nbt);
        progress = nbt.getInt("ultimate_quarry.progress");
    }

    private static boolean hasFuelInFuelSlot(UltimateQuarryBlockEntity entity) {
    ...
    private static void craftItem(UltimateQuarryBlockEntity entity) {
        ...
        if(hasRecipe(entity)) {
            ...
            if(entity.getStack(0).getDamage() < entity.getStack(0).getMaxDamage()) {
                ...
                entity.setStack(3, new ItemStack(TechItems.EMPTY_FUEL_CELL,
