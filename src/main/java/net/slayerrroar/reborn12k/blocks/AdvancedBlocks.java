...
public class AdvancedBlocks {
    ...
    public static final Block SUN_GEM = registerBlock("moon_gem", new GemBlock(FabricBlockSettings.copyOf(Blocks.AMETHYST_BLOCK).sounds(BlockSoundGroup.AMETHYST_BLOCK).hardness(1.0f).resistance(20.0f).nonOpaque()), Reborn12KItemGroup.REBORN12K);
    public static final Block MOON_GEM = registerBlock("sun_gem", new GemBlock(FabricBlockSettings.copyOf(Blocks.AMETHYST_BLOCK).sounds(BlockSoundGroup.AMETHYST_BLOCK).hardness(1.0f).resistance(20.0f).nonOpaque()), Reborn12KItemGroup.REBORN12K);
