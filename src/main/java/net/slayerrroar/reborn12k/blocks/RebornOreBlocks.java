...
public class RebornOreBlocks {
    ...
    public static final Block NICHIRIN_ORE = registerBlock("nichirin_ore", new ExperienceDroppingBlock(FabricBlockSettings.copyOf(Blocks.DIAMOND_ORE).requiresTool().sounds(BlockSoundGroup.STONE).hardness(4.0f).resistance(3.0f)), Reborn12KItemGroup.REBORN12K);
