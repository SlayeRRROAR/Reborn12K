...
public class ArcaneArtifactDisplay extends BasicDisplay implements SimpleGridMenuDisplay {
    private RecipeEntry<?> recipe;
    //private double cookTime;

    /*public ArcaneArtifactDisplay(RecipeEntry<? extends ArcaneArtifactRecipe> recipe) {
    ...
    /*public ArcaneArtifactDisplay(List<EntryIngredient> input, List<EntryIngredient> output, NbtCompound tag) {
    ...
    /*public ArcaneArtifactDisplay(List<EntryIngredient> input, List<EntryIngredient> output, @Nullable RecipeEntry<?> recipe, double cookTime) {
        super(input, output, Optional.ofNullable(recipe).map(RecipeEntry::id));
        this.recipe = recipe;
        this.cookTime = cookTime;
    }*/

    public ArcaneArtifactDisplay(List<EntryIngredient> input, List<EntryIngredient> output, @Nullable RecipeEntry<?> recipe) {
        super(input, output, Optional.ofNullable(recipe).map(RecipeEntry::id));
        this.recipe = recipe;
    }
    ...
    /*public static <R extends ArcaneArtifactDisplay> BasicDisplay.Serializer<R> serializer(BasicDisplay.Serializer.RecipeLessConstructor<R> constructor) {
