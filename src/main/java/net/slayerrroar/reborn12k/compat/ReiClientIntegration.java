...
import net.slayerrroar.reborn12k.compat.arcane_artifact.*;
import net.slayerrroar.reborn12k.compat.crusher.*;
import net.slayerrroar.reborn12k.compat.mana_condenser.*;
import net.slayerrroar.reborn12k.compat.manufactory.*;
import net.slayerrroar.reborn12k.compat.melter.*;
import net.slayerrroar.reborn12k.compat.quarry.*;
