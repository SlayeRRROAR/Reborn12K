...
public enum CustomArmorMaterials implements ArmorMaterial {
    ...
    THELOSITE("bronze", 42, new int[] {5, 9, 11, 6}, 15, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE,
            6.0F, 0.3F, ItemGenerics.THELOSITE_INGOT),
    ...
    ADVANCED_ALLOY("advanced_alloy", 41, new int[] {3, 6, 8, 3}, 15, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE,
            2.0F, 0.1F, ItemGenerics.ADVANCED_ALLOY_INGOT),
    ...
    SIGNALUM("signalum", 34, new int[] {3, 6, 8, 3}, 22, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE,
            3.0F, 0.1F, ItemGenerics.SIGNALUM_INGOT),
    ENDERIUM("enderium", 38, new int[] {5, 9, 11, 6}, 30, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE,
            5.0F, 0.2F, ItemGenerics.ENDERIUM_INGOT),
    MAGISTEEL("magisteel", 42, new int[] {3, 6, 8, 3}, 22, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND,
            0.0F, 0.0F, ItemGenerics.MAGISTEEL_INGOT),
    ORICHALCUM("orichalcum", 42, new int[] {3, 6, 8, 3}, 22, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE,
            0.0F, 0.0F, ItemGenerics.ORICHALCUM_INGOT),
    MITHRIL("mithril", 42, new int[] {5, 9, 11, 6}, 22, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE,
            0.0F, 0.0F, ItemGenerics.MITHRIL_INGOT),

    MAGE("mage", 38, new int[] {3, 6, 8, 3}, 30, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER,
            2.0F, 0.2F, ItemMagic.MANAWEAVE),
    POWER("power", 50, new int[] {5, 9, 11, 6}, 1, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE,
