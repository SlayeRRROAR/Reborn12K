...
public class CustomVillagers {
    ...
    public static final VillagerProfession DEALER = registerDealer("dealer", DEALER_POI);

    public static final PointOfInterestType BLACKSMITH_POI = registerPOI("blacksmithpoi", AdvancedBlocks.ALLOY_FURNACE);
    public static final VillagerProfession BLACKSMITH = registerBlacksmith("blacksmith", BLACKSMITH_POI);


    public static VillagerProfession registerBlacksmith(String name, PointOfInterestType type) {
    ...
    public static VillagerProfession registerDealer(String name, PointOfInterestType type) {
        return Registry.register(Registry.VILLAGER_PROFESSION, new Identifier(Reborn12K.MOD_ID, name),
                VillagerProfessionAccessor.create(name, type, ImmutableSet.of(), ImmutableSet.of(),
