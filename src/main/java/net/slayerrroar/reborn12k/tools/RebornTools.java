...
public class RebornTools {
    ...
    public static Item WOODEN_PAXEL = registerItem("wooden_paxel", new BasePaxel(ToolMaterials.WOOD, 6, -3.2f, new FabricItemSettings()));
    ...
    public static Item STONE_PAXEL = registerItem("stone_paxel", new BasePaxel(ToolMaterials.STONE, 7, -3.2f, new FabricItemSettings()));

    public static Item IRON_KATANA = registerItem("iron_katana", new BaseSword(ToolMaterials.IRON, 1, -1.6f, new FabricItemSettings()));
    public static Item IRON_PAXEL = registerItem("iron_paxel", new BasePaxel(ToolMaterials.IRON, 6, -3.1f, new FabricItemSettings()));
    ...
    public static Item GOLDEN_PAXEL = registerItem("golden_paxel", new BasePaxel(ToolMaterials.GOLD, 6, -3.0f, new FabricItemSettings()));
    ...
    public static Item DIAMOND_PAXEL = registerItem("diamond_paxel", new BasePaxel(ToolMaterials.DIAMOND, 5, -3.0f, new FabricItemSettings()));
    ...
    public static Item NETHERITE_PAXEL = registerItem("netherite_paxel", new BasePaxel(ToolMaterials.NETHERITE, 5, -3.0f, new FabricItemSettings().fireproof()));
    ...
    public static Item ARCHEOSITE_SHOVEL = registerItem("archeosite_shovel", new BaseShovel(RebornToolMaterials.ARCHEOSITE, 1, -3.0f, new FabricItemSettings().fireproof()));
    ...
    public static Item ARCHEOSITE_AXE = registerItem("archeosite_axe", new BaseAxe(RebornToolMaterials.ARCHEOSITE, 5, -3.0f, new FabricItemSettings().fireproof()));
    ...
    public static Item ARCHEOSITE_PAXEL = registerItem("archeosite_paxel", new BasePaxel(RebornToolMaterials.ARCHEOSITE, 5, -3.0f, new FabricItemSettings().fireproof()));
    ...
    public static Item BRONZE_SHOVEL = registerItem("bronze_shovel", new BaseShovel(RebornToolMaterials.BRONZE, 2, -3.1f, new FabricItemSettings()));
    ...
    public static Item BRONZE_PAXEL = registerItem("bronze_paxel", new BasePaxel(RebornToolMaterials.BRONZE, 7, -3.1f, new FabricItemSettings()));
    ...
    public static Item STEEL_SHOVEL = registerItem("steel_shovel", new BaseShovel(RebornToolMaterials.STEEL, 1, -3.0f, new FabricItemSettings()));
    ...
    public static Item STEEL_AXE = registerItem("steel_axe", new BaseAxe(RebornToolMaterials.STEEL, 5, -3.0f, new FabricItemSettings()));
    ...
    public static Item STEEL_PAXEL = registerItem("steel_paxel", new BasePaxel(RebornToolMaterials.STEEL, 5, -3.0f, new FabricItemSettings()));
    ...
    public static Item TUNGSTENSTEEL_SHOVEL = registerItem("tungstensteel_shovel", new BaseShovel(RebornToolMaterials.TUNGSTENSTEEL, 1, -3.0f, new FabricItemSettings().fireproof()));
    ...
    public static Item TUNGSTENSTEEL_AXE = registerItem("tungstensteel_axe", new BaseAxe(RebornToolMaterials.TUNGSTENSTEEL, 5, -3.0f, new FabricItemSettings().fireproof()));
    ...
    public static Item TUNGSTENSTEEL_PAXEL = registerItem("tungstensteel_paxel", new BasePaxel(RebornToolMaterials.TUNGSTENSTEEL, 5, -3.0f, new FabricItemSettings().fireproof()));
    ...
    public static Item THELOSITE_SHOVEL = registerItem("thelosite_shovel", new BaseShovel(RebornToolMaterials.THELOSITE, 1, -3.0f, new FabricItemSettings().fireproof()));
    ...
    public static Item THELOSITE_AXE = registerItem("thelosite_axe", new BaseAxe(RebornToolMaterials.THELOSITE, 5, -3.0f, new FabricItemSettings().fireproof()));
    ...
    public static Item THELOSITE_PAXEL = registerItem("thelosite_paxel", new BasePaxel(RebornToolMaterials.THELOSITE, 5, -3.0f, new FabricItemSettings().fireproof()));
    ...
    public static Item TITANIUM_SHOVEL = registerItem("titanium_shovel", new BaseShovel(RebornToolMaterials.TITANIUM, 1, -3.0f, new FabricItemSettings()));
    ...
    public static Item TITANIUM_AXE = registerItem("titanium_axe", new BaseAxe(RebornToolMaterials.TITANIUM, 6, -3.0f, new FabricItemSettings()));
    ...
    public static Item TITANIUM_PAXEL = registerItem("titanium_paxel", new BasePaxel(RebornToolMaterials.TITANIUM, 5, -3.0f, new FabricItemSettings()));
    ...
    public static Item ADVANCED_ALLOY_SHOVEL = registerItem("advanced_alloy_shovel", new BaseShovel(RebornToolMaterials.ADVANCED_ALLOY, 1, -3.0f, new FabricItemSettings()));
    ...
    public static Item ADVANCED_ALLOY_AXE = registerItem("advanced_alloy_axe", new BaseAxe(RebornToolMaterials.ADVANCED_ALLOY, 5, -3.0f, new FabricItemSettings()));
    ...
    public static Item ADVANCED_ALLOY_PAXEL = registerItem("advanced_alloy_paxel", new BasePaxel(RebornToolMaterials.ADVANCED_ALLOY, 5, -3.0f, new FabricItemSettings()));
    ...
    public static Item IRIDIUM_ALLOY_SHOVEL = registerItem("iridium_alloy_shovel", new BaseShovel(RebornToolMaterials.IRIDIUM_ALLOY, 1, -3.0f, new FabricItemSettings().fireproof()));
    ...
    public static Item IRIDIUM_ALLOY_AXE = registerItem("iridium_alloy_axe", new BaseAxe(RebornToolMaterials.IRIDIUM_ALLOY, 5, -3.0f, new FabricItemSettings().fireproof()));
    ...
    public static Item IRIDIUM_ALLOY_PAXEL = registerItem("iridium_alloy_paxel", new BasePaxel(RebornToolMaterials.IRIDIUM_ALLOY, 5, -3.0f, new FabricItemSettings().fireproof()));
    ...
    public static Item ELECTRUM_SHOVEL = registerItem("electrum_shovel", new BaseShovel(RebornToolMaterials.ELECTRUM, 1, -3.0f, new FabricItemSettings()));
    ...
    public static Item ELECTRUM_AXE = registerItem("electrum_axe", new BaseAxe(RebornToolMaterials.ELECTRUM, 4, -3.0f, new FabricItemSettings()));
    ...
    public static Item ELECTRUM_PAXEL = registerItem("electrum_paxel", new BasePaxel(RebornToolMaterials.ELECTRUM, 4, -3.0f, new FabricItemSettings()));
    ...
    public static Item SIGNALUM_SHOVEL = registerItem("signalum_shovel", new BaseShovel(RebornToolMaterials.SIGNALUM, 1, -3.0f, new FabricItemSettings()));
    ...
    public static Item SIGNALUM_AXE = registerItem("signalum_axe", new BaseAxe(RebornToolMaterials.SIGNALUM, 5, -3.0f, new FabricItemSettings()));
    ...
    public static Item SIGNALUM_PAXEL = registerItem("signalum_paxel", new BasePaxel(RebornToolMaterials.SIGNALUM, 5, -3.0f, new FabricItemSettings()));
    ...
    public static Item ENDERIUM_SHOVEL = registerItem("enderium_shovel", new BaseShovel(RebornToolMaterials.ENDERIUM, 1, -3.0f, new FabricItemSettings().fireproof()));
    ...
    public static Item ENDERIUM_AXE = registerItem("enderium_axe", new BaseAxe(RebornToolMaterials.ENDERIUM, 5, -3.0f, new FabricItemSettings().fireproof()));
    ...
    public static Item MAGISTEEL_AXE = registerItem("magisteel_axe", new BaseAxe(RebornToolMaterials.MAGISTEEL, 5, -3.0f, new FabricItemSettings().fireproof()));
    ...
    public static Item MAGISTEEL_PAXEL = registerItem("magisteel_paxel", new BasePaxel(RebornToolMaterials.MAGISTEEL, 5, -3.0f, new FabricItemSettings().fireproof()));
    ...
    public static Item ORICHALCUM_SHOVEL = registerItem("orichalcum_shovel", new BaseShovel(RebornToolMaterials.ORICHALCUM, 1, -3.0f, new FabricItemSettings().fireproof()));
    ...
    public static Item ORICHALCUM_AXE = registerItem("orichalcum_axe", new BaseAxe(RebornToolMaterials.ORICHALCUM, 5, -3.0f, new FabricItemSettings().fireproof().fireproof()));
    ...
    public static Item ORICHALCUM_PAXEL = registerItem("orichalcum_paxel", new BasePaxel(RebornToolMaterials.ORICHALCUM, 5, -3.0f, new FabricItemSettings().fireproof()));
    ...
    public static Item MITHRIL_SHOVEL = registerItem("mithril_shovel", new BaseShovel(RebornToolMaterials.MITHRIL, 1, -3.0f, new FabricItemSettings().fireproof()));
    ...
    public static Item MITHRIL_AXE = registerItem("mithril_axe", new BaseAxe(RebornToolMaterials.MITHRIL, 5, -3.0f, new FabricItemSettings().fireproof()));
