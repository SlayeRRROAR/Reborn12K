...
public class RebornTools {
    ...
    public static Item ARCHEOSITE_HOE = registerItem("archeosite_hoe", new BaseHoe(RebornToolMaterials.ARCHEOSITE, -7, 0.0f, new FabricItemSettings().fireproof()));
    ...
    public static Item BRONZE_SHOVEL = registerItem("bronze_shovel", new BaseShovel(RebornToolMaterials.BRONZE, 2, -3.0f, new FabricItemSettings()));
    ...
    public static Item BRONZE_HOE = registerItem("bronze_hoe", new BaseHoe(RebornToolMaterials.BRONZE, -1, -1.0f, new FabricItemSettings()));
    ...
    public static Item STEEL_HOE = registerItem("steel_hoe", new BaseHoe(RebornToolMaterials.STEEL, -4, 0.0f, new FabricItemSettings()));
    ...
    public static Item TUNGSTENSTEEL_HOE = registerItem("tungstensteel_hoe", new BaseHoe(RebornToolMaterials.TUNGSTENSTEEL, -5, 0.0f, new FabricItemSettings().fireproof()));
    ...
    public static Item THELOSITE_HOE = registerItem("thelosite_hoe", new BaseHoe(RebornToolMaterials.THELOSITE, -8, 0.0f, new FabricItemSettings().fireproof()));
    ...
    public static Item TITANIUM_HOE = registerItem("titanium_hoe", new BaseHoe(RebornToolMaterials.TITANIUM, -2, 0.0f, new FabricItemSettings()));
    ...
    public static Item ADVANCED_ALLOY_HOE = registerItem("advanced_alloy_hoe", new BaseHoe(RebornToolMaterials.ADVANCED_ALLOY, -3, 0.0f, new FabricItemSettings()));
    ...
    public static Item IRIDIUM_ALLOY_HOE = registerItem("iridium_alloy_hoe", new BaseHoe(RebornToolMaterials.IRIDIUM_ALLOY, -6, 0.0f, new FabricItemSettings().fireproof()));
    ...
    public static Item ELECTRUM_AXE = registerItem("electrum_axe", new BaseAxe(RebornToolMaterials.ELECTRUM, 5, -3.0f, new FabricItemSettings()));
    public static Item ELECTRUM_HOE = registerItem("electrum_hoe", new BaseHoe(RebornToolMaterials.ELECTRUM, -3, 0.0f, new FabricItemSettings()));
    ...
    public static Item SIGNALUM_HOE = registerItem("signalum_hoe", new BaseHoe(RebornToolMaterials.SIGNALUM, -4, 0.0f, new FabricItemSettings()));
    ...
    public static Item ENDERIUM_HOE = registerItem("enderium_hoe", new BaseHoe(RebornToolMaterials.ENDERIUM, -7, 0.0f, new FabricItemSettings().fireproof()));
    ...
    public static Item MAGISTEEL_HOE = registerItem("magisteel_hoe", new BaseHoe(RebornToolMaterials.MAGISTEEL, -3, 0.0f, new FabricItemSettings().fireproof()));
    ...
    public static Item ORICHALCUM_HOE = registerItem("orichalcum_hoe", new BaseHoe(RebornToolMaterials.ORICHALCUM, -3, 0.0f, new FabricItemSettings().fireproof().fireproof()));
    ...
    public static Item MITHRIL_HOE = registerItem("mithril_hoe", new BaseHoe(RebornToolMaterials.MITHRIL, -3, 0.0f, new FabricItemSettings().fireproof()));
