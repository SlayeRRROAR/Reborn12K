...
public class RebornTools {
    ...
    public static Item WOODEN_KATANA = registerItem("wooden_katana", new BaseSword(WoodMaterial.INSTANCE, 1, -1.6f, new FabricItemSettings()));
    public static Item STONE_KATANA = registerItem("stone_katana", new BaseSword(StoneMaterial.INSTANCE, 1, -1.6f, new FabricItemSettings()));
    public static Item IRON_KATANA = registerItem("iron_katana", new BaseSword(IronMaterial.INSTANCE, 1, -1.6f, new FabricItemSettings()));
    public static Item DIAMOND_KATANA = registerItem("diamond_katana", new BaseSword(DiamondMaterial.INSTANCE, 0, -1.6f, new FabricItemSettings()));
    public static Item NETHERITE_KATANA = registerItem("netherite_katana", new BaseSword(NetheriteMaterial.INSTANCE, 0, -1.6f, new FabricItemSettings().fireproof()));
    public static Item GOLDEN_KATANA = registerItem("golden_katana", new BaseSword(GoldMaterial.INSTANCE, 1, -1.6f, new FabricItemSettings()));
    ...
    public static Item ARCHEOSITE_KATANA = registerItem("archeosite_katana", new BaseSword(ArcheositeMaterial.INSTANCE, 0, -1.6f, new FabricItemSettings().fireproof()));
    ...
    public static Item BRONZE_KATANA = registerItem("bronze_katana", new BaseSword(BronzeMaterial.INSTANCE, 1, -1.6f, new FabricItemSettings()));
    ...
    public static Item STEEL_KATANA = registerItem("steel_katana", new BaseSword(SteelMaterial.INSTANCE, 0, -1.6f, new FabricItemSettings()));
    ...
    public static Item TUNGSTENSTEEL_KATANA = registerItem("tungstensteel_katana", new BaseSword(TungstensteelMaterial.INSTANCE, 0, -1.6f, new FabricItemSettings().fireproof()));
    ...
    public static Item THELOSITE_KATANA = registerItem("thelosite_katana", new BaseSword(ThelositeMaterial.INSTANCE, 0, -1.6f, new FabricItemSettings().fireproof()));
    ...
    public static Item TITANIUM_KATANA = registerItem("titanium_katana", new BaseSword(TitaniumMaterial.INSTANCE, 0, -1.6f, new FabricItemSettings()));
    ...
    public static Item ADVANCED_ALLOY_KATANA = registerItem("advanced_alloy_katana", new BaseSword(AdvancedAlloyMaterial.INSTANCE, 0, -1.6f, new FabricItemSettings()));
    ...
    public static Item IRIDIUM_ALLOY_KATANA = registerItem("iridium_alloy_katana", new BaseSword(IridiumAlloyMaterial.INSTANCE, 0, -1.6f, new FabricItemSettings().fireproof()));
    ...
    public static Item ELECTRUM_KATANA = registerItem("electrum_katana", new BaseSword(ElectrumMaterial.INSTANCE, 0, -1.6f, new FabricItemSettings()));
    ...
    public static Item SIGNALUM_KATANA = registerItem("signalum_katana", new BaseSword(SignalumMaterial.INSTANCE, 0, -1.6f, new FabricItemSettings()));
    ...
    public static Item ENDERIUM_KATANA = registerItem("enderium_katana", new BaseSword(EnderiumMaterial.INSTANCE, 0, -1.6f, new FabricItemSettings().fireproof()));
    ...
    public static Item MAGISTEEL_KATANA = registerItem("magisteel_katana", new BaseSword(MagisteelMaterial.INSTANCE, 0, -1.6f, new FabricItemSettings().fireproof()));
    ...
    public static Item ORICHALCUM_KATANA = registerItem("orichalcum_katana", new BaseSword(OrichalcumMaterial.INSTANCE, 0, -1.6f, new FabricItemSettings().fireproof()));
    ...
    public static Item MITHRIL_KATANA = registerItem("mithril_katana", new BaseSword(MithrilMaterial.INSTANCE, 0, -1.6f, new FabricItemSettings().fireproof()));
