...
public class RebornItems {
    ...
    public static final Item RAW_NICHIRIN = registerItem("raw_nichirin", new Item(new FabricItemSettings()));
    ...
    public static final Item NICHIRIN_INGOT = registerItem("nichirin_ingot", new Item(new FabricItemSettings()));
    ...
    public static void addItemsToItemGroup() {
        ...
        addToItemGroup(Reborn12KItemGroup.REBORN12K, RAW_NICHIRIN);
        ...
        addToItemGroup(Reborn12KItemGroup.REBORN12K, NICHIRIN_INGOT);
    ...
    public static void register() {
        addItemsToItemGroup();
        Reborn12K.LOGGER.info(Reborn12K.MOD_ID + ": Correctly registered General Items");
    }
}