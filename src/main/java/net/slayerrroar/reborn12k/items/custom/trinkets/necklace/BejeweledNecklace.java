...
public class BejeweledNecklace extends TrinketItem implements Trinket {
    ...
    public Multimap<EntityAttribute, EntityAttributeModifier> getModifiers(ItemStack stack, SlotReference slot, LivingEntity entity, UUID uuid) {
        ...
        modifiers.put(EntityAttributes.GENERIC_MAX_HEALTH, new EntityAttributeModifier(uuid, "reborn12k:max_health", 0.4, EntityAttributeModifier.Operation.MULTIPLY_TOTAL));
    ...
    public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext) {
        tooltip.add(Text.translatable("item.reborn12k.bejeweled_necklace.tooltip1"));
        tooltip.add(Text.translatable("item.reborn12k.bejeweled_necklace.tooltip2"));
