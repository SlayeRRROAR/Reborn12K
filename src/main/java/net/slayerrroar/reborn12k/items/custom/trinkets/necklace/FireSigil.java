...
public class FireSigil extends TrinketItem implements Trinket {
    public FireSigil(Settings settings) {
        super(settings);
    }
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        ...
        tooltip.add(Text.translatable("item.reborn12k.fire_sigil.tooltip1"));
        tooltip.add(Text.translatable("item.reborn12k.fire_sigil.tooltip2"));
