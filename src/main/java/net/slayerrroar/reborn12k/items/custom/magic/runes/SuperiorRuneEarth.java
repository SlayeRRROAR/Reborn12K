...
public class SuperiorRuneEarth extends Item {
    public SuperiorRuneEarth(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (block.isOf(Blocks.EMERALD_BLOCK) && world.getBlockState(pos.down()).isOf(Blocks.BEDROCK)) {
            world.breakBlock(pos, false);
            dropStack(world, pos, new ItemStack(AdvancedBlocks.EARTH_GEM));
