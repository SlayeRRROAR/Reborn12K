...
public class IndelibleTonic extends TrinketItem implements Trinket {
    ...
    public Multimap<EntityAttribute, EntityAttributeModifier> getModifiers(ItemStack stack, SlotReference slot, LivingEntity entity, UUID uuid) {
        ...
        modifiers.put(EntityAttributes.GENERIC_ATTACK_SPEED, new EntityAttributeModifier(uuid, "generic_attack_speed", 0.15, EntityAttributeModifier.Operation.MULTIPLY_TOTAL));
        return modifiers;
    }
