...
public class WaterPendant extends TrinketItem implements Trinket {
    ...
    public boolean canEquip(ItemStack stack, SlotReference slot, LivingEntity entity) {
        return TrinketsApi.getTrinketComponent(entity).get().isEquipped(ItemTrinkets.WATER_IMPULSE);
    }
    ...
    public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext) {
        tooltip.add(Text.translatable("item.reborn12k.deepfrost_pendant.tooltip1"));
        tooltip.add(Text.translatable("item.reborn12k.deepfrost_pendant.tooltip2"));
