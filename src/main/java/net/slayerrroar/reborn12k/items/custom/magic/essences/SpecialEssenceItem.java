...
public class SpecialEssenceItem extends Item {
    public SpecialEssenceItem(Settings settings) {
        super(settings);
    }
    ...
    public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext) {
        ...
        tooltip.add(Text.translatable("item.reborn12k.special_essence.tooltip"));
    }
}
