...
public class Staffs {
    ...
    public static final Item ARCHMAGE_STAFF = new Item(new FabricItemSettings().group(Reborn12KItemGroup.REBORN12K));
    ...
    public static void register() {
        ...
        Registry.register(Registry.ITEM, new Identifier(Reborn12K.MOD_ID, "archmage_staff"), ARCHMAGE_STAFF);
