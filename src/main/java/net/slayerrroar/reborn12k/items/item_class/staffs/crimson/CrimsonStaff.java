...
public class CrimsonStaff extends Item {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity playerEntity, Hand hand) {
        ...
        if(hit.getType() == HitResult.Type.ENTITY) {
            ...
            playerEntity.world.createExplosion(playerEntity, entity.getX(), entity.getY(), entity.getZ(), 4.0F, World.ExplosionSourceType.NONE);
            playerEntity.getItemCooldownManager().set(this, 8*20);
            ...
            playerEntity.world.createExplosion(playerEntity, blockPos.getX()+.5, blockPos.getY()+1.1, blockPos.getZ()+.5, 4.0F, World.ExplosionSourceType.NONE);
            playerEntity.getItemCooldownManager().set(this, 8*10);
        }
