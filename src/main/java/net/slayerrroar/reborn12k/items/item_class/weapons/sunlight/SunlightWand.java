...
public class SunlightWand extends Item {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity playerEntity, Hand hand) {
        ...
        playerEntity.addStatusEffect(new StatusEffectInstance(StatusEffects.REGENERATION, 20*5, 0));
        ...
        for (Entity e : world.getOtherEntities(playerEntity, Box.of(playerEntity.getPos(), 20, 20, 20))) {
            if (e instanceof LivingEntity livingEntity) {
                if (playerEntity.distanceTo(livingEntity) < 20) {
                    ...
                    livingEntity.addStatusEffect(new StatusEffectInstance(StatusEffects.REGENERATION, 20*5, 0));
                }
            }
        }
