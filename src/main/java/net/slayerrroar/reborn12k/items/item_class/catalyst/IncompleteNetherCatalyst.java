...
public class IncompleteNetherCatalyst extends Item {
    public IncompleteNetherCatalyst(Settings settings) {
        super(settings);
    }
    ...
    public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext) {
        ...
        tooltip.add(Text.translatable("item.reborn12k.incomplete_nether_catalyst.tooltip", remaining));
    }
    ...
    public ActionResult useOnEntity(ItemStack itemStack, PlayerEntity user, LivingEntity entity, Hand hand) {
        ...
        if(itemStack.getDamage() >= 63) {
            ...
            user.dropItem(MagicItems.NETHER_CATALYST);
            return ActionResult.SUCCESS;
        }
