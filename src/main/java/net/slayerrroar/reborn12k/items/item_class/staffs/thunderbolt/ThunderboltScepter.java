package net.slayerrroar.reborn12k.items.item_class.staffs.thunderbolt;
...
public class ThunderboltScepter extends Item {

    public ThunderboltScepter(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity playerEntity, Hand hand) {
        ...
        if(hit.getType() == HitResult.Type.BLOCK) {
            ...
            playerEntity.getItemCooldownManager().set(this, 35*20);
