...
public class CrimsonRod extends Item {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity playerEntity, Hand hand) {
        ...
        if(hit.getType() == HitResult.Type.ENTITY) {
            ...
            playerEntity.world.createExplosion(playerEntity, entity.getX(), entity.getY(), entity.getZ(), 5.0F, World.ExplosionSourceType.NONE);
            ...
            playerEntity.world.createExplosion(playerEntity, blockPos.getX()+.5, blockPos.getY()+1.1, blockPos.getZ()+.5, 6.0F, World.ExplosionSourceType.NONE);
            playerEntity.getItemCooldownManager().set(this, 12*20);
        }
