...
public class CrimsonWand extends Item {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity playerEntity, Hand hand) {
        ...
        if(hit.getType() == HitResult.Type.ENTITY) {
            ...
            playerEntity.world.createExplosion(playerEntity, entity.getX(), entity.getY(), entity.getZ(), 2.0F, Explosion.DestructionType.NONE);
            ...
            playerEntity.world.createExplosion(playerEntity, blockPos.getX()+.5, blockPos.getY()+1.1, blockPos.getZ()+.5, 2.0F, Explosion.DestructionType.NONE);
            playerEntity.getItemCooldownManager().set(this, 9*20);
        }
