...
public class ArcaneArtifactRecipe implements Recipe<SimpleInventory> {
    ...
    public ArcaneArtifactRecipe(Identifier id, ItemStack output, DefaultedList<Ingredient> recipeItems) {
        this.id = id;
        this.output = output;
    ...
    public static class Serializer implements RecipeSerializer<ArcaneArtifactRecipe> {
        ...
        @Override
        public ArcaneArtifactRecipe read(Identifier id, JsonObject json) {
            ...
            return new ArcaneArtifactRecipe(id, output, inputs);
        }
