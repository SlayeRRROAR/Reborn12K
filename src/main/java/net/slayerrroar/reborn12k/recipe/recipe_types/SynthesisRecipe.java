...
public class SynthesisRecipe implements Recipe<SimpleInventory> {

    private final Identifier id;
    private final ItemStack output;
    private final DefaultedList<Ingredient> recipeItems;

    public SynthesisRecipe(Identifier id, ItemStack output, DefaultedList<Ingredient> recipeItems) {
        this.id = id;
        this.output = output;
    ...
    public static class Serializer implements RecipeSerializer<SynthesisRecipe> {
        ...
        public SynthesisRecipe read(Identifier id, JsonObject json) {
            ...
            return new SynthesisRecipe(id, output, inputs);
        }
